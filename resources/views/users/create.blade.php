        ...
        <div class="card border-dark shadow">
            ...
            <form method="post" action="{{ url('/add-user') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="" class="form-control mb-2" placeholder="Name">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput"><b>Email Address:</b></label>
                    <input type="email" name="email" value="" class="form-control mb-2" placeholder="name@example.com">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput"><b>Password:</b></label>
                    <input type="password" name="password" value="" class="form-control mb-2" placeholder="Password">
                ...
                <select name="role[]" class="form-select form-select" aria-label=".form-select-sm example" multiple>
                    ...
                    <option value="Sales/Marketing Rep">Sales/Marketing Rep</option>
